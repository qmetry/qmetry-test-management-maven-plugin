...
<plugin>
	...
	<configuration>
		...
		<customTemplateName>TestingTemplate</customTemplateName>
		...
		<testRunFields>{"userDefinedFields":{"Integrate":"Custom Field Testsuite"}}</testRunFields> <!-- Supports UDFs only-->
